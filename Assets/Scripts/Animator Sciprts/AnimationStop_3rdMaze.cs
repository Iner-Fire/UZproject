...
public class AnimationStop_3rdMaze : MonoBehaviour
{
    private int klucze;
    ...
    void Update()
    {
        ...
        doorPosition = GameObject.FindGameObjectWithTag("MidDoor");
        ...
        if (Input.GetKeyDown(KeyCode.E) && klucze >= 1)
        {
            ...
            if (anim != null)
            {
                if (anim.runtimeAnimatorController != null)
                {
                    ...
                    {
                        Destroy(GameObject.FindGameObjectWithTag("Collider_mid1"));
